...
namespace ForeingExchangeWin2
{
    public partial class MainPage : ContentPage
    {
        ...
        void ConvertButton_Clicked(object sender, System.EventArgs e)
        {
            ...
            {
                DisplayAlert("Error", "You must enter a velue in pesos...", "Accept");
                return;
            }
            decimal pesos = 0;
            ...
            {
                DisplayAlert("Error", "You must enter a velue numeric in pesos...", "Accept");
